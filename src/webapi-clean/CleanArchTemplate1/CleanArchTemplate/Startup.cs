using CleanArchTemplate.Extensions;
using CleanArchTemplate.Middlewares;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.Configure<TemplateOptions>(Configuration.GetSection(nameof(TemplateOptions)));

        services.AddDependencieInjections();
